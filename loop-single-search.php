...
<article class="list_result">
    ...
    <?php } ?>
                ...
                <div class="list_textbox">
                		<h1><a href="<?php echo osc_item_url() ; ?>" ><?php echo osc_item_title() ; ?>(<?php echo osc_item_category() ; ?>)</a></h1>
                        <h3><a href="<?php echo osc_item_url() ; ?>" ><?php echo osc_item_city(); //osc_item()['s_city'];?> - (<?php echo osc_item_region(); ?>) - <?php echo osc_format_date(osc_item_pub_date()); ?>.</a></h3>
