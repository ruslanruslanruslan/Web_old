...
<div class="rsearch">
        ...
        <figure>
          <?php if (osc_images_enabled_at_items()) { ?>
                <?php if (osc_count_item_resources()) { ?>
					...
					<img src="<?php echo osc_resource_thumbnail_url(); ?>" title="" alt="<?php echo osc_item_title(); ?>" width="50" height="50">
					</a>
                <?php } else { ?>
				    <a href="<?php echo osc_item_url(); ?>" >
    ...
    <div class="mctooltip_box">
        <span class="price_span"><?php bender_draw_dropdown(); ?></span>
        <span class="florida_right_bor"><?php echo osc_item_city() ?> <br/> <?php echo osc_format_date(osc_item_pub_date()); ?></span>
    </div>
</div>
