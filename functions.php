...
if (!function_exists('bender_draw_categories_list')) {
    ...
    if (!function_exists('bender_draw_dropdown')) {
        ...
        function bender_draw_dropdown($premium = false) {
            //echo '<a href="#" class="rate">'.osc_item_formated_price().'</a>';
            if ($premium) {
                echo '<a class="rate">' . isha_premium_formated_price() . '</a>';
            } else {
    ...
    function osc_format_price2($price, $symbol = null) {
        ...
        if($symbol==null) { $symbol = osc_item_currency_symbol2(); }
        $price = $price/1000000;
